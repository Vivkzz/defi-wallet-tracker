  ...
  return (
    <div className={cn("glass-card rounded-xl", className)}>
      <div className="p-6 border-b border-border-soft">
        ...
        <p className="text-sm text-muted-foreground mt-1">Your crypto portfolio breakdown</p>
      </div>
      
      <div className="divide-y divide-border-soft">
        {tokens.map((token) => (
          <div key={token.id} className="p-6 hover:bg-muted/20 transition-colors">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className={cn(
                    ...
                    token.riskScore >= 80 ? "bg-success/20 text-success" :
                    token.riskScore >= 60 ? "bg-warning/20 text-warning" :
